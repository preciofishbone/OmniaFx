...
>Note: The following example will continue what we have done in [Call a Web API](https://github.com/preciofishbone/OmniaFx/tree/master/docs/tutorials/first-extension/call-web-api) so make sure you've been through it.
...
>Tip: For more publishing options visit [omnia-dev-publish](../../cli/README.md)
...
>Tip: For more pushing options visit [omnia-dev-publish](../../cli#omnia-extensions-push)
...
If you are serving the extension locally in the [previous step this tutorial](./create-extension#step-5-serve-the-extension-locally), you need to stop it first 
