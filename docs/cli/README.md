...
- [Extension Commands](#extension-commands)
  - [omnia extensions new](#omnia-extensions-new)
        - [Example](#example-43)
        - [Required Parameters](#required-parameters-50)
        - [Optional Parameters](#optional-parameters-38)
  - [omnia extensions restart](#omnia-extensions-restart)
        - [Example](#example-44)
        - [Required Parameters](#required-parameters-51)
        - [Optional Parameters](#optional-parameters-39)
  - [omnia extensions list](#omnia-extensions-list)
        - [Example](#example-45)
        - [Required Parameters](#required-parameters-52)
        - [Optional Parameters](#optional-parameters-40)
  - [omnia extensions versions](#omnia-extensions-versions)
        - [Example](#example-46)
        - [Required Parameters](#required-parameters-53)
        - [Optional Parameters](#optional-parameters-41)
  - [omnia extensions push](#omnia-extensions-push)
        - [Example](#example-47)
        - [Required Parameters](#required-parameters-54)
        - [Optional Parameters](#optional-parameters-42)
  - [omnia extensions deploy](#omnia-extensions-deploy)
        - [Example](#example-48)
        - [Required Parameters](#required-parameters-55)
        - [Optional Parameters](#optional-parameters-43)
  - [omnia extensions retract](#omnia-extensions-retract)
        - [Example](#example-49)
        - [Required Parameters](#required-parameters-56)
        - [Optional Parameters](#optional-parameters-44)
  - [omnia extensions revert](#omnia-extensions-revert)
        - [Example](#example-50)
        - [Required Parameters](#required-parameters-57)
        - [Optional Parameters](#optional-parameters-45)
  - [omnia extensions delete-version](#omnia-extensions-delete-version)
        - [Example](#example-51)
        - [Required Parameters](#required-parameters-58)
  - [omnia extensions update-version status](#omnia-extensions-update-version-status)
        - [Example](#example-52)
        - [Required Parameters](#required-parameters-59)
- [Extension Groups Commands](#extension-groups-commands)
  - [omnia extgroups new](#omnia-extgroups-new)
        - [Example](#example-53)
        - [Required Parameters](#required-parameters-60)
        - [Optional Parameters](#optional-parameters-46)
  - [omnia extgroups addversion](#omnia-extgroups-addversion)
        - [Example](#example-54)
        - [Required Parameters](#required-parameters-61)
        - [Optional Parameters](#optional-parameters-47)
  - [omnia extgroups deleteversion](#omnia-extgroups-deleteversion)
        - [Example](#example-55)
        - [Required Parameters](#required-parameters-62)
        - [Optional Parameters](#optional-parameters-48)
  - [omnia extgroups delete](#omnia-extgroups-delete)
        - [Example](#example-56)
        - [Required Parameters](#required-parameters-63)
        - [Optional Parameters](#optional-parameters-49)
- [Deployment Groups Commands](#deployment-groups-commands)
  - [omnia depgroups new](#omnia-depgroups-new)
        - [Example](#example-57)
        - [Required Parameters](#required-parameters-64)
        - [Optional Parameters](#optional-parameters-50)
  - [omnia depgroups addtarget](#omnia-depgroups-addtarget)
        - [Example](#example-58)
        - [Required Parameters](#required-parameters-65)
        - [Optional Parameters](#optional-parameters-51)
  - [omnia depgroups deletetarget](#omnia-depgroups-deletetarget)
        - [Example](#example-59)
        - [Required Parameters](#required-parameters-66)
        - [Optional Parameters](#optional-parameters-52)
  - [omnia depgroups delete](#omnia-depgroups-delete)
        - [Example](#example-60)
        - [Required Parameters](#required-parameters-67)
        - [Optional Parameters](#optional-parameters-53)
- [Extension Secret Commands](#extension-secret-commands)
  - [omnia secrets add](#omnia-secrets-add)
        - [Example](#example-61)
        - [Required Parameters](#required-parameters-68)
        - [Optional Parameters](#optional-parameters-54)
  - [omnia secrets remove](#omnia-secrets-remove)
        - [Example](#example-62)
        - [Required Parameters](#required-parameters-69)
  - [omnia secrets list](#omnia-secrets-list)
        - [Example](#example-63)
        - [Required Parameters](#required-parameters-70)
        - [Optional Parameters](#optional-parameters-55)
- [Cloud Secret Commands](#cloud-secret-commands)
  - [omnia cloudsecrets add](#omnia-cloudsecrets-add)
        - [Example](#example-64)
        - [Required Parameters](#required-parameters-71)
        - [Optional Parameters](#optional-parameters-56)
  - [omnia cloudsecrets update](#omnia-cloudsecrets-update)
        - [Example](#example-65)
        - [Required Parameters](#required-parameters-72)
  - [omnia cloudsecrets remove](#omnia-cloudsecrets-remove)
        - [Example](#example-66)
        - [Required Parameters](#required-parameters-73)
  - [omnia cloudsecrets list](#omnia-cloudsecrets-list)
        - [Example](#example-67)
        - [Optional Parameters](#optional-parameters-57)
  - [omnia cloudsecrets renew](#omnia-cloudsecrets-renew)
        - [Example](#example-68)
        - [Required Parameters](#required-parameters-74)
        - [Optional Parameters](#optional-parameters-58)
- [Tenant Certificate Commands](#tenant-certificate-commands)
  - [omnia certs export](#omnia-certs-export)
        - [Example](#example-69)
        - [Required Parameters](#required-parameters-75)
        - [Optional Parameters](#optional-parameters-59)
  - [omnia certs add](#omnia-certs-add)
        - [Example](#example-70)
        - [Required Parameters](#required-parameters-76)
  - [omnia certs adddigicert](#omnia-certs-adddigicert)
        - [Example](#example-71)
        - [Required Parameters](#required-parameters-77)
        - [Optional Parameters](#optional-parameters-60)
      - [Notes](#notes)
  - [omnia certs list](#omnia-certs-list)
        - [Example](#example-72)
        - [Optional Parameters](#optional-parameters-61)
  - [omnia certs update](#omnia-certs-update)
        - [Example](#example-73)
        - [Required Parameters](#required-parameters-78)
  - [omnia certs cloudupdate (deprecated, the new ways is "omnia certs clouddeploy" instead)](#omnia-certs-cloudupdate-deprecated-the-new-ways-is-omnia-certs-clouddeploy-instead)
        - [Example](#example-74)
        - [Required Parameters](#required-parameters-79)
      - [Notes](#notes-1)
  - [omnia certs reissue](#omnia-certs-reissue)
        - [Example](#example-75)
        - [Required Parameters](#required-parameters-80)
        - [Optional Parameters](#optional-parameters-62)
  - [omnia certs import](#omnia-certs-import)
        - [Example](#example-76)
        - [Required Parameters](#required-parameters-81)
        - [Optional Parameters](#optional-parameters-63)
  - [omnia certs clouddeploy](#omnia-certs-clouddeploy)
        - [Example](#example-77)
        - [Required Parameters](#required-parameters-82)
        - [Optional Parameters](#optional-parameters-64)
      - [Notes](#notes-2)
  - [omnia domain update](#omnia-domain-update)
        - [Example](#example-78)
        - [Required Parameters](#required-parameters-83)
  - [omnia domain dnspreview](#omnia-domain-dnspreview)
        - [Example](#example-79)
        - [Required Parameters](#required-parameters-84)
  - [omnia certs delete](#omnia-certs-delete)
        - [Example](#example-80)
        - [Required Parameters](#required-parameters-85)
        - [Optional Parameters](#optional-parameters-65)
- [Localization Commands](#localization-commands)
  - [omnia loc upload](#omnia-loc-upload)
        - [Example](#example-81)
        - [Required Parameters](#required-parameters-86)
  - [omnia loc delete](#omnia-loc-delete)
        - [Example](#example-82)
        - [Required Parameters](#required-parameters-87)
  - [omnia loc list](#omnia-loc-list)
        - [Example](#example-83)
        - [Optional Parameters](#optional-parameters-66)
  - [omnia loc download](#omnia-loc-download)
        - [Example](#example-84)
        - [Required Parameters](#required-parameters-88)
        - [Optional Parameters](#optional-parameters-67)
  - [omnia loc diff](#omnia-loc-diff)
        - [Example](#example-85)
        - [Required Parameters](#required-parameters-89)
        - [Optional Parameters](#optional-parameters-68)
  - [omnia loc patch](#omnia-loc-patch)
        - [Example](#example-86)
        - [Required Parameters](#required-parameters-90)
        - [Optional Parameters](#optional-parameters-69)
      - [omnia loc-translation-rules import](#omnia-loc-translation-rules-import)
        - [Example](#example-87)
        - [Required Parameters](#required-parameters-91)
      - [omnia loc-translation-rules download](#omnia-loc-translation-rules-download)
        - [Example](#example-88)
        - [Required Parameters](#required-parameters-92)
        - [Optional Parameters](#optional-parameters-70)
- [Permissions Commands](#permissions-commands)
  - [All permission roles available in Omnia Cli:](#all-permission-roles-available-in-omnia-cli)
  - [omnia permissions add](#omnia-permissions-add)
        - [Example](#example-89)
        - [Required Parameters](#required-parameters-93)
        - [Optional Parameters](#optional-parameters-71)
  - [omnia permission remove](#omnia-permission-remove)
        - [Example](#example-90)
        - [Required Parameters](#required-parameters-94)
        - [Optional Parameters](#optional-parameters-72)
  - [omnia permissions list](#omnia-permissions-list)
        - [Example](#example-91)
        - [Required Parameters](#required-parameters-95)
        - [Optional Parameters](#optional-parameters-73)
- [Alert Rules Commands](#alert-rules-commands)
  - [omnia alertrules new](#omnia-alertrules-new)
        - [Example](#example-92)
        - [Required Parameters](#required-parameters-96)
        - [Optional Parameters](#optional-parameters-74)
  - [omnia alertrules update](#omnia-alertrules-update)
        - [Example](#example-93)
        - [Required Parameters](#required-parameters-97)
        - [Optional Parameters](#optional-parameters-75)
  - [omnia alertrules list](#omnia-alertrules-list)
        - [Example](#example-94)
        - [Required Parameters](#required-parameters-98)
        - [Optional Parameters](#optional-parameters-76)
  - [omnia alertrules delete](#omnia-alertrules-delete)
        - [Example](#example-95)
        - [Required Parameters](#required-parameters-99)
        - [Optional Parameters](#optional-parameters-77)
- [Resource Providers Commands](#resource-providers-commands)
  - [omnia resourceproviders list](#omnia-resourceproviders-list)
        - [Example](#example-96)
        - [Required Parameters](#required-parameters-100)
        - [Optional Parameters](#optional-parameters-78)
  - [omnia resourceproviders add](#omnia-resourceproviders-add)
        - [Example](#example-97)
        - [Required Parameters](#required-parameters-101)
        - [Optional Parameters](#optional-parameters-79)
- [Elastic Pools Commands](#elastic-pools-commands)
  - [omnia elasticpools new](#omnia-elasticpools-new)
        - [Example](#example-98)
        - [Required Parameters](#required-parameters-102)
        - [Optional Parameters](#optional-parameters-80)
  - [omnia elasticpools update](#omnia-elasticpools-update)
        - [Example](#example-99)
        - [Required Parameters](#required-parameters-103)
        - [Optional Parameters](#optional-parameters-81)
  - [omnia elasticpools list](#omnia-elasticpools-list)
        - [Example](#example-100)
        - [Required Parameters](#required-parameters-104)
        - [Optional Parameters](#optional-parameters-82)
  - [omnia elasticpools delete](#omnia-elasticpools-delete)
        - [Example](#example-101)
        - [Required Parameters](#required-parameters-105)
        - [Optional Parameters](#optional-parameters-83)
  - [omnia elasticpools ensure](#omnia-elasticpools-ensure)
        - [Example](#example-102)
        - [Required Parameters](#required-parameters-106)
        - [Optional Parameters](#optional-parameters-84)
- [Reporting Commands](#reporting-commands)
  - [omnia reports new](#omnia-reports-new)
        - [Example](#example-103)
        - [Required Parameters](#required-parameters-107)
        - [Optional Parameters](#optional-parameters-85)
  - [omnia reports list](#omnia-reports-list)
        - [Example](#example-104)
        - [Required Parameters](#required-parameters-108)
        - [Optional Parameters](#optional-parameters-86)
  - [omnia reports delete](#omnia-reports-delete)
        - [Example](#example-105)
        - [Required Parameters](#required-parameters-109)
        - [Optional Parameters](#optional-parameters-87)
- [Regular Mode Deployment for version 6 to 7 ](#regular-mode-deployment-for-version-6-to-7-)
  - [Phase 1 - Deploy and run migration](#phase-1---deploy-and-run-migration)
        - [Optional Commands](#optional-commands)
        - [Required Commands](#required-commands)
  - [Phase 2 - Finishing](#phase-2---finishing)
        - [Optional Commands](#optional-commands-1)
  - [Phase 3 - Revert (If Any)](#phase-3---revert-if-any)
        - [Required Commands](#required-commands-1)
        - [Optional Commands](#optional-commands-2)
- [Readonly Mode Deployment for version 6 to 7 ](#readonly-mode-deployment-for-version-6-to-7-)
  - [Phase 1 - Initial](#phase-1---initial)
        - [Optional Commands](#optional-commands-3)
        - [Required Commands](#required-commands-2)
  - [Phase 2 - Execution Migration](#phase-2---execution-migration)
        - [Optional Commands](#optional-commands-4)
        - [Required Commands](#required-commands-3)
  - [Phase 3 - Apply new databases](#phase-3---apply-new-databases)
        - [Required Commands](#required-commands-4)
  - [Phase 4 - Finishing](#phase-4---finishing)
        - [Optional Commands](#optional-commands-5)
        - [Required Commands](#required-commands-5)
  - [Phase 5 - Revert (If Any)](#phase-5---revert-if-any)
        - [Required Commands](#required-commands-6)
        - [Optional Commands](#optional-commands-6)
